...
/**
 * Concrete Strategy class for fetching a set of data as zero-based arrays from a Model statement. The result set is 
 ...
 */
class ModelArraySetFetchStrategy extends ModelSetFetchStrategy
{
	/**
